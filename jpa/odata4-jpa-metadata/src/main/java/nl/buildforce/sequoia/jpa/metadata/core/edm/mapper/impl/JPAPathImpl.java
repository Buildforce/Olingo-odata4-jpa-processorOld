...
final class JPAPathImpl implements JPAPath {
   ...
   * @see nl.buildforce.sequoia.jpa.metadata.core.edm.mapper.impl.JPAPath#getAlias()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.jpa.metadata.core.edm.mapper.impl.JPAPath#getDBFieldName()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.jpa.metadata.core.edm.mapper.impl.JPAPath#getLeaf()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.jpa.metadata.core.edm.mapper.impl.JPAPath#getPath()
   */
  @Override
   ...
   * @see nl.buildforce.sequoia.jpa.metadata.core.edm.mapper.impl.JPAPath#ignore()
   */
  @Override
