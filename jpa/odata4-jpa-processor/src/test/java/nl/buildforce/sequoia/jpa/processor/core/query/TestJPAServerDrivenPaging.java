...
import nl.buildforce.sequoia.jpa.processor.core.util.CountQueryMatcher;
...
public class TestJPAServerDrivenPaging extends TestBase {
  ...
  private UriInfo buildUriInfo() throws EdmPrimitiveTypeException {
    ...
    when(et.getFullQualifiedName()).thenReturn(new FullQualifiedName("nl.buildforce.sequoia.jpa", "Organization"));
