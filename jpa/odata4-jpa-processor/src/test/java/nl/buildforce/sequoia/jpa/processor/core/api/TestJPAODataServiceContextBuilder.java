...
import nl.buildforce.sequoia.jpa.processor.core.api.example.JPAExamplePagingProvider;
...
public class TestJPAODataServiceContextBuilder {
  ...
  private static final String[] enumPackages = {"nl.buildforce.sequoia.jpa.processor.core.testmodel"};
  ...
  public void checkArrayOnProvidedPackages() throws ODataException {
    cut = JPAODataServiceContext.with()
            .setDataSource(ds)
            .setPUnit(PUNIT_NAME)
            .setTypePackage("org.apache.olingo.jpa.bl", "nl.buildforce.sequoia.jpa.processor.core.testmodel")
            .build();
