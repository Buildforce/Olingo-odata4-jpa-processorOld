...
insert into "BusinessPartner" values ('99', 0, '1', '','',null,null,'Max','Mustermann',null,'Test Straße', '12','', 'Teststadt','10115','ISO', '3166-2','DE-BE', 'DEU', '', '','','', '99','2016-01-20 09:21:23', '', null, 'DEU', null, 2);
...
insert into "CountryDescription" values( 'BEL','nl','België');
insert into "CountryDescription" values( 'CHE','de','Schweiz');
insert into "CountryDescription" values( 'CHE','en','Switzerland');
insert into "CountryDescription" values( 'CHE','nl','Zwitserland');
insert into "CountryDescription" values( 'DEU','de','Deutschland');
insert into "CountryDescription" values( 'DEU','en','Germany');
insert into "CountryDescription" values( 'DEU','nl','Duitsland');
insert into "CountryDescription" values( 'FRA','de','Frankreich');
insert into "CountryDescription" values( 'FRA','en','France');
insert into "CountryDescription" values( 'FRA','nl','Frankrijk');
insert into "CountryDescription" values( 'GBR','de','Vereinigtes Königreich');
insert into "CountryDescription" values( 'GBR','en','United Kingdom');
insert into "CountryDescription" values( 'GBR','nl','Verenigd Koninkrijk');
insert into "CountryDescription" values( 'USA','de','Vereinigte Staaten');
insert into "CountryDescription" values( 'USA','en','United States');
insert into "CountryDescription" values( 'USA','nl','Verenigde Staten');
...
CREATE VIEW "BusinessPartnerProtected" AS
	SELECT DISTINCT
		b."ID",
		b."ETag",
		b."Type",
...
CREATE VIEW "PersonProtected" AS
	SELECT
		b."ID",
		b."ETag",
		b."Type",
